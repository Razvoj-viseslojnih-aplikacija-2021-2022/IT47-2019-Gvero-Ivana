...
ALTER TABLE fakultet ALTER COLUMN id SET DEFAULT nextval('fakultet_seq');
ALTER TABLE departman ALTER COLUMN id SET DEFAULT nextval('departman_seq');
ALTER TABLE status ALTER COLUMN id SET DEFAULT nextval('status_seq');
